...
class PredictionEngine(threading.Thread):
    ...
    def __init__(self, update_interval, notification_man, database):
        ...
        self.PULSE_HIGH = 0
        self.OXYGEN_LOW = 0
        self.DIASTOLIC_LOW = 0
        self.DIASTOLIC_HIGH = 0
        self.SYSTOLIC_LOW = 0
        self.SYSTOLIC_HIGH = 0
    ...
    def update_setting(self, pulse_low=60, pulse_high=100, oxy_low=50, diastolic_low=60, diastolic_high=80,
                       systolic_low=90, systolic_high=120):
    ...
    def patient_condition(self):
        ...
        '''
            Allow one number is abnormal at one time. More than two 
        '''
        if self.count == 0:
            return True
        elif self.count == 1:
    ...
    def run(self):
        ...
        while True:
            ...
            if not self.patient_condition() and self.urgency >= 2:
                '''
